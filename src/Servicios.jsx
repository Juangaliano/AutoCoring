function Servicios() {
  return (
    <div>
      ...
      <div className="flex max-w-[1224px] flex-col items-center justify-center w-90px gap-5 py-20 md:px-5 m-auto text-center ">
      ...
      <div>
        <div className="flex max-w-[1224px] flex-col md:items-center justify-center w-90px gap-5  py-20 px-5 m-auto text-center mt-5">
          <h2 className="text-[#374649] text-3xl font-bold">
            ¿Cómo te acompañamos?
          </h2>
          <p>
        ...
        <div className="flex flex-col items-center justify-center gap-5 m-auto my-5 md:flex-row w-90px ">
          <div className="flex flex-col gap-8 w-full md:w-[25%] items-center justify-center text-center h-[350px] p-3  bg-white shadow-xl group hover:border-t-4 hover:border-t-[#074CA6]">
            <div className="w-[80px] font-bold text-4xl group-hover:hidden text-[#074CA6]">
              1
            </div>
            <p className="font-bold group-hover:text-2xl">
            ...
            <ul className="flex flex-col items-start pl-5 text-sm list-disc text-start">
              ...
              <li>Relevamiento de procesos operativos y de apoyo</li>
              <li>
      ...
      >
        <div className="flex flex-col items-start justify-center h-full m-auto font-normal w-90px">
          <h2 className="mb-4 text-3xl leading-normal text-start">
            ¿Querés conocer más acerca de este servicio?
          </h2>
          <input
            type="button"
